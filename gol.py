...
CELL_SIZE = 1  # Cell size in pixels
WINDOW_WIDTH = 1000  # Width of the window
WINDOW_HEIGHT = 1000  # Height of the window
FRAME_DELAY = 1  # The game will only update every 2th frame
